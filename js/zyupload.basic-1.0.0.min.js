		...
		return this.each(function() {
			...
			this.createHtml = function() {
				...
				if(para.dragDrop) {
					...
					html += '					<div class="upload_btn">保存</div>';
					html += "				</div>";
					html += "			</div>";
					html += '			<div id="preview" class="upload_preview"></div>';
					html += "		</div>";
					html += '		<div class="upload_submit">';
					html += '			<button type="button" id="fileSubmit" class="upload_submit_btn">确认保存文件</button>';
					html += "		</div>";
			...
			this.funDisposePreviewHtml = function(file, e) {
				...
				if(file.type.indexOf("image") == 0) {
					...
					html += '	<p id="uploadFailure_' + file.index + '" class="file_failure">保存失败，请重试</p>';
...
//						};
					...
					onFailure: function(file, response) {
						...
						$("#uploadInf").append("<p>文件" + file.name + "保存失败！</p>")
					},
					onComplete: function(response) {
